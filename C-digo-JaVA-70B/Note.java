...
```sh
java --enable-preview --source 22 Hello.java Nur_IAI
```
...
## [JEP 11] (Rellena Formulario: evento 11)
$ mkdir example; cd example                                                         $ jbang init hello.java                                                             [jbang] File initialized. You can now run it with 'jbang hello.java' or edit it using 'jbang edit --open=[editor] hello.java' where [editor] is your editor or IDE, e.g. 'netbeans'                                                                         $ # Now we run it using jbang                                                       $ jbang hello.java                                                                  Hello World                                                                         $ # In a bash or zsh shell you run the file directly                                $ ./hello.java                                                                      Hello World                                                                         $ # That was the basics - now lets create an example using 3rd party dependencies   $ jbang init -t cli hellocli.java                                                   [jbang] File initialized. You can now run it with 'jbang hellocli.java' or edit it using 'jbang edit --open=[editor] hellocli.java' where [editor] is your editor or IDE, e.g. 'vi'                                                                         $ # This creates a hello world using picocli and gives you built in help            $ ./hellocli.java --help                                                            [jbang] Building jar...                                                             Usage: hellocli [-hV] <greeting>                                                    hellocli made with jbang                                                                  <greeting>   The greeting to print                                              -h, --help       Show this help message and exit.                                   -V, --version    Print version information and exit.                              $ ./hellocli.j